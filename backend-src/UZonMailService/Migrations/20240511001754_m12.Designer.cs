...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FileUsageSendingItem2", b =>
                {
                    b.Property<int>("AttachmentsId")
                        .HasColumnType("INTEGER");

                    b.Property<int>("SendingItem2Id")
                        .HasColumnType("INTEGER");

                    b.HasKey("AttachmentsId", "SendingItem2Id");

                    b.HasIndex("SendingItem2Id");

                    b.ToTable("FileUsageSendingItem2");
                });
            ...
            modelBuilder.Entity("UZonMailService.Models.SqlLite.EmailSending.SendingItem2", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("FileUsageSendingItem2", b =>
                {
                    ...
                    b.HasOne("UZonMailService.Models.SqlLite.EmailSending.SendingItem2", null)
                        .WithMany()
                        .HasForeignKey("SendingItem2Id")
                        .OnDelete(DeleteBehavior.ClientNoAction)
                        .IsRequired();
                });
